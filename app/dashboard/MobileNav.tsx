...
export default function MobileNav({setShowModal}: any) { 
    ...
    return (
         <div className='w-2/3 h-[100vh] fixed top-0 right-0 md:hidden block bg-[#81c784] z-50'>
            <nav className='w-full flex flex-col h-[100vh] p-4 space-y-8'>
                <div className="w-full flex items-center space-between">
                    <div className="mr-[75px]">
                        <Link href="/" className='hover:text-white mt-4 mb-8 font-bold text-xl text-gray-300'>MediMerge</Link>
                    </div>
                ...
                <div className="w-full flex items-center">
                     ...
                     <Link href="/sales" className="text-[#9AA8BD] hover:text-white">Sale Bills</Link>
                </div>
